...
//		        
			...
			$result = eF_getTableData("users u, users_to_lessons ul, user_types as ut", "u.login, ul.lessons_ID, ul.done_content", "ul.archive=0 and ul.user_type in ('".implode("','", array_keys(EfrontLessonUser::getStudentRoles()))."')  and u.login = ul.users_LOGIN and u.login in ('".implode("','", $users)."') and ul.lessons_ID in (".implode(",", $lessons).")");
